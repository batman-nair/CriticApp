...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOST', 'criticapp-db'),
...
# CORS allowed origins for decoupled frontend (comma-separated URLs)
...
# Exempt health and metrics endpoints from SSL redirect for internal access
